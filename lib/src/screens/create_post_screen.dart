...
class _CreatePostScreenState extends State<CreatePostScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('New Post', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w800, fontSize: 18)),
        backgroundColor: Colors.white,
        elevation: 0,
        leading: IconButton(
          ...
          Padding(
            ...
            child: _isLoading
                ...
                : FilledButton(
                    ...
                    child: Text('Post', style: GoogleFonts.plusJakartaSans(fontWeight: FontWeight.w800, fontSize: 14)),
                  ),
          ),
        ],
      ),
      body: Column(
        children: [
          ...
          Container(
            ...
            child: Row(
              children: [
                _toolbarButton(Icons.photo_library_rounded, 'Photos', _pickImages),
                if (_selectedImages.isNotEmpty)
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Text('${_selectedImages.length} photo${_selectedImages.length > 1 ? 's' : ''}',
